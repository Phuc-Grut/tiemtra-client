...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***©***REMOVED***{new***REMOVED***Date().getFullYear()}***REMOVED***Rookie-Coders.***REMOVED***All***REMOVED***rights***REMOVED***reserved.
