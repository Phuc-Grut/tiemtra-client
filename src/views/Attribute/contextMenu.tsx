...
const***REMOVED***desiredOrder***REMOVED***=***REMOVED***["EDIT",***REMOVED***"DELETE"];

export***REMOVED***const***REMOVED***atrrinuteContextMenuItems:***REMOVED***IContextMenu[]***REMOVED***=***REMOVED***desiredOrder
