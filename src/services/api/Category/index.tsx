...
const categoryApi = {
    ...
    checkCanDeleteManyCategories: (ids: number[]): Promise<AxiosResponse<any>> => requester.post(CATEGORY.URL_API.CHECK_DELETE_BY_IDS, ids),
    deleteManyCategories: (ids: number[]): Promise<AxiosResponse<any>> => requester.delete(CATEGORY.URL_API.DELETE_API_BY_IDS, { data: ids }),
}
