...
export const ATTRIBUTE = {
  ...
  URL_API: {
    ...
    UPDATE_API: (id: number) =>
      `${URL_ADMIN}/attributes/update-attributes/${id}`,
...
export const STORE_PPRODUCT = {
  URL_API: {
    ...
    GET_PRODUCT_BY_CODE: (productCode: string) =>
      `${URL_STORE}/product/get-product-by-code/${productCode}`,
  },
};
...
export const ADMIN_ORDER = {
  URL_API: {
    ...
    COMFIRM_ORDER: (orderId: string) =>
      `${URL_ADMIN}/order/confirm-order/${orderId}`,
...
export const ADMIN_VOUCHER = {
  URL_API: {
    CREATE: `${URL_ADMIN}/voucher/create`,
    GET_PAGING: `${URL_ADMIN}/voucher/get-paging`,
    GET_BY_ID: (id: string) => `${URL_ADMIN}/voucher/get-by-id/${id}`,
